...
import 'package:first/models/ChampionSummary.dart';
import 'package:first/models/champion.dart';
import 'package:first/models/championDetail.dart';
import 'package:http/http.dart';

final String championMasteryPath =
    'lol/champion-mastery/v4/champion-masteries/by-summoner/';
final String championSummaryPath =
    'https://raw.communitydragon.org/pbe/plugins/rcp-be-lol-game-data/global/cs_cz/v1/champion-summary.json';
...
Future<List<Champion>> getHighMasteryChamp(encryptedSummonerName) async {
  ...
  List<Champion> list =
      await getChampionMasteryBySummonerName(encryptedSummonerName);
...
Future<List<ChampionSummary>> getChampionSummary() async {
  final Response response =
      await loggingInterceptor.getInterceptorClient().get(championSummaryPath);
...
Future<ChampionDetail> getChampionDetail(
    String nameChamp, String version) async {
